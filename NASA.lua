...
LuaTele = luatele.set_config{api_id=24354213,api_hash='9d4ac7828ca092cc2f68f4202d84b452',session_name=NASA,token=Token}
function var(value)
...
data = {
{
{text = '👤 | مبرمج السورس', url = 't.me/GJEGG'}, 
},
{
{text = '🔘 | تواصل معنا', url = 't.me/GJEGG'}, 
},
}
}
...
{
{text = '☢️ | اضغط هنا لتنصيب', url = 't.me/GJEGG'}, 
},
{
{text = '🔘 | تواصل معنا', url = 't.me/GJEGG'}, 
},
